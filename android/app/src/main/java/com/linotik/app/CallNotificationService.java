...
public class CallNotificationService extends FirebaseMessagingService {
    ...
    private void handleCallNotification(Map<String, String> data,SQLiteDatabase db) {
        ...
        if(Objects.equals(handlerType, "Newchannel")){
            ...
            try {
                sendMessageNotification(contactName, URLDecoder.decode(data.get("content"), StandardCharsets.UTF_8.toString()), db);
    ...
    private void sendMessageNotification(String callerName,String content,SQLiteDatabase db){
        ...
        db.insert("messages",null,notifValue);
